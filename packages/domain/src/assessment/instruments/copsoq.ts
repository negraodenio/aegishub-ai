...
export const COPSOQ_DIMENSIONS: Record<string, COPSOQDimension> = {
  QD: { code: "QD", name: "Exigências Quantitativas", category: "demandas", isPositive: false },
  ED: { code: "ED", name: "Exigências Emocionais", category: "demandas", isPositive: false },
  ...
  SLP: { code: "SLP", name: "Sintomas de Burnout", category: "resultados", isPositive: false },
  JS: { code: "JS", name: "Satisfação no Trabalho", category: "resultados", isPositive: true },
  OB: { code: "OB", name: "Comportamentos Ofensivos", category: "relacoes", isPositive: false }
};
